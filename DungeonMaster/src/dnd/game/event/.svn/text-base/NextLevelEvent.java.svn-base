...
/**
 * NextLevelEvent class defines a structure for passing data related to
...
public class NextLevelEvent extends GameEvent {
	 ...
	 */
	public NextLevelEvent(World world) {
		this.world = world;
	}
	...
	public String toString() {
		return "Player went down a dungeon level and gained a level";
	}
}
